...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = _interopRequire(__webpack_require__(1));

	var Blinds = _interopRequire(__webpack_require__(2));

	var Pot = _interopRequire(__webpack_require__(3));

	var Debts = _interopRequire(__webpack_require__(4));

	var Clock = _interopRequire(__webpack_require__(5));

	var _variablesJs = __webpack_require__(6);

	var startingSeconds = _variablesJs.startingSeconds;
	var payouts = _variablesJs.payouts;
	var buyIn = _variablesJs.buyIn;
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            "div",
	                            { className: "col1" },
	                            React.createElement(Blinds, null)
	                        ),
	                        React.createElement(
	                            "div",
	                            { className: "col2" },
	                            React.createElement(Timer, { startingTime: startingSeconds })
	                        ),
	                        React.createElement(
	                            "div",
	                            { className: "col3" },
	                            React.createElement(Pot, { payouts: payouts, buyIn: buyIn }),
	                            React.createElement(Debts, null)
	                        ),
	                        React.createElement("div", { className: "clear-both" })
	                    )
	                );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = (function (_React$Component) {
	    ...
	    _createClass(Timer, {
	        ...
	        tick: {
	            value: function tick() {
	                var nextSecondsLeft = this.state.secondsLeft - 1;
	        ...
	        displayTime: {
	            value: function displayTime(secondsLeft) {
	                var displayMinutes = Math.floor(secondsLeft / 60);
	                var displaySeconds = secondsLeft % 60 < 10 ? "0" + secondsLeft % 60 : secondsLeft % 60;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var smallBlinds = [100, 200, 300, 500, 800, 1000, 1500, 2000, 3000, 5000];

	var Blind = (function (_React$Component) {
	    function Blind() {
	    ...
	    _inherits(Blind, _React$Component);
	    ...
	    _createClass(Blind, {
	        render: {
	            value: function render() {
	                ...
	                return React.createElement(
	                    "li",
	                    { key: this.props.key, className: classString },
	                    smallBlinds[this.props.index],
	                    " / ",
	                    smallBlinds[this.props.index] * 2
	                );
	            }
	        }
	    });
	...
	var Blinds = (function (_React$Component2) {
	    function Blinds(props) {
	        _classCallCheck(this, Blinds);
	    ...
	    _inherits(Blinds, _React$Component2);

	    _createClass(Blinds, {
	        raiseBlinds: {
	            value: function raiseBlinds() {
	                if (this.state.activeIndex + 1 > smallBlinds.length - 1) {
	                    return;
	                }
	        ...
	        render: {
	            value: function render() {
	                ...
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        "ul",
	                        { className: "current-blinds" },
	                        React.createElement(
	                            "li",
	                            null,
	                            "Current Blind:"
	                        ),
	                        React.createElement(Blind, { index: this.state.activeIndex })
	                    ),
	                    React.createElement(
	                        "ul",
	                        { className: "blinds-list" },
	                        smallBlinds.map(function (blind, index) {
	                            return React.createElement(Blind, { index: index, key: index, active: index === _this.state.activeIndex });
	                        })
	                    ),
	                    React.createElement(
	                        "button",
	                        { onClick: this.raiseBlinds },
	                        "Raise"
	                    ),
	                    React.createElement(
	                        "button",
	                        { onClick: this.lowerBlinds },
	                        "Lower"
	                    )
	                );
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ordinalAbbrev = function (ordinal) {
	    if (ordinal === 1) {
	        return "st";
	    } else if (ordinal === 2) {
	        return "nd";
	...
	var Pot = (function (_React$Component) {
	    ...
	    _createClass(Pot, {
	        registerBuyIn: {
	            value: function registerBuyIn(modifier) {
	            ...
	            value: function render() {
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "payouts" },
	                        this.props.payouts(this.state.pot).map(function (payout, index) {
	                            return React.createElement(
	                                "div",
	                                { className: "payout" },
	                                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            "button",
	                            { onClick: this.registerBuyIn.bind(this, 1) },
	                            "+ Buy In"
	                        ),
	                        React.createElement(
	                            "button",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Debt = (function (_React$Component) {
	    function Debt(props) {
	    ...
	    _inherits(Debt, _React$Component);
	    ...
	    _createClass(Debt, {
	        ...
	        render: {
	            value: function render() {
	                ...
	                return React.createElement(
	                    "li",
	                    { className: classString, onClick: this.togglePaid, key: this.props.key },
	                    this.props.debt
	                );
	            }
	        }
	...
	var Debts = (function (_React$Component2) {
	    ...
	    _inherits(Debts, _React$Component2);

	    _createClass(Debts, {
	        handleSubmit: {
	            value: function handleSubmit(event) {
	                event.preventDefault();
	                var debt = React.findDOMNode(this.refs["debt-input"]).value.trim();
	        ...
	        listDebts: {
	            value: function listDebts() {
	                ...
	                debts.map(function (debt, index) {
	                    debtsList.push(React.createElement(Debt, { key: index, debt: debt }));
	                });
	                return debtsList;
	            }
	        },
	            ...
	            value: function render() {
	                return React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement("input", { ref: "debt-input", type: "text", placeholder: "(enter new debt)" })
	                    ),
	                    React.createElement(
	                        "div",
	                        { className: "settle" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var buyIn = 20;
	exports.buyIn = buyIn;
	var startingSeconds = 15 * 60;
	exports.startingSeconds = startingSeconds;
